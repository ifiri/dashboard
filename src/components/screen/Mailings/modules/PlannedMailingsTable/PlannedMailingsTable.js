...
import styles from './PlannedMailingsTable.module.scss';

export default function PlannedMailingsTable({ items = [], onDelete, ...rest}) {
  return (
    <DataTable
      { ...rest }
    >
